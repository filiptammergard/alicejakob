<template>
  <div id="welcome-component">
    <section class="white front-image-color background-element">
      ...
      <a href="#info" class="scroll-down" :class="{ hide: coronaMessageVisible }"></a>
    </section>
      ...
      <div class="card text-center shadow">
        ...
        <div class="card-body">
          <p>
            ...
            bröllopsfest i den utformningen vi hade planerat.<br />
            Samtidigt är det nästan tre månader kvar och vi hoppas fortfarande att vi kommer kunna
            ha bröllopsfesten som planerat med alla er där. Om det inte blir fallet kommer vi
            utforma vårt bröllop på ett annat sätt och göra det så bra vi kan utifrån
            förutsättningarna och vad som känns rätt för oss. Oavsett kommer vi ta ett beslut och
            informera er senast i början av juni, när vi vet mer om läget och myndigheter har kommit
            ut med mer information och riktlinjer. Vi skjuter därmed också upp OSA datum till den
            15e juni. Ta hand om er! <br /><br />
